...
const Header = () => {
    return (
        <>
            <header className="bg-accent text-white relative h-16 ">
                <h1 className="text-3xl font-Rockn text-center pt-4">
                    <Link href="/">YAMAORI</Link>
                </h1>
            </header>
            <nav className="bg-bg border-b-4 border-b-border text-text flex py-4 pl-8 justify-between mx-auto md:pr-8 lg:pr-16 w-full">
