...
const TopImage = () => {
    return (
        <div className="relative">
            ...
            <h3 className="block md:hidden absolute right-16 top-8 font-serif text-xl text-text tracking-widest leading-relaxed [writing-mode:vertical-rl]">生きるには、<br />山や自然との<br />関りから得られる<br />心にくべる薪が<br />必要なんです。</h3>
        </div>
